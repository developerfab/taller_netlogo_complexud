;; Se crea la raza carros
;; Se debe recordar que siempre se declara primero
;; el plural de la raza y luego el singular.

breed [carros carro]

;; Se crea el procedimiento setup el cual en este caso
;; crea 10 carros y cambia su forma, color y cada uno
;; da 10 pasos al frente.
...
to setup
  ...
  ;; se modifican las propiedades de todos los carros
  ask carros [
    ;; se modifica el tamaño de los agentes
    set size 3
    ;; se dan 4 pasos al frente
    fd 4
    ;; se cambia el icono del agente
    set shape "car"
    ;; se cambia el color del agente
    set color red
  ]
end
@#$#@#$#@
